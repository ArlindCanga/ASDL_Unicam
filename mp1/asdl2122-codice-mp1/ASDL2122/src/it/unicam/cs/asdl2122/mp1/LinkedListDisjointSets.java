 ...
 * disgiunto. Ogni Nodo contiene un DisjointSetElement il quale rappresenta la  composizione
 * di un insieme disgiunto.
 *
...
public class LinkedListDisjointSets implements DisjointSets {
    ...
    public void makeSet(DisjointSetElement e) {
        ...
        // ogni primo elemento di un insieme disgiunto lo segno come rappresentante
        e.setRef1(e);
        e.setNumber(1); //size dell'insieme
    ...
    public DisjointSetElement findSet(DisjointSetElement e) {
        ...
        if (!(this.head == null)){
            ...
            while (currentNode != null){
                DisjointSetElement currentElement = currentNode.item;
                // una volta trovato e restituisco il suo rappresentante
                while(currentElement != null){
                    if (currentElement.equals(e)){
    ...
    public void union(DisjointSetElement e1, DisjointSetElement e2) {
        ...
        while ((currentNode != null) && (element1 == null || element2 == null)){
            ...
            while((currentElement != null) && (element1 == null || element2 == null)){
                //faccio questi controlli perchè nel caso e1.size = e2.size
                // unisco sx <-- sy
        ...
        //se non fanno parte dello stesso Nodo  procedo con l'unione
        if (!(element1.item.equals(element2.item))){
            ...
            //inizio con l'unione degli insiemi
            DisjointSetElement e3 = element2.item;
            // Cambio il rappresentate dell'insieme sy
            while (e3 != null){
