...
public class Aula implements Comparable<Aula> {
    ...
    public boolean addFacility(Facility f) {
        ...
        try{
            ...
            //se c'è bisogno creo un array con dimensione doppia di quella precedente
    ...
    public boolean satisfiesFacilities(Facility[] requestedFacilities) {
        ...
        boolean satisfy;
        for(Facility objFacility : requestedFacilities){
            satisfy = false;
            if(objFacility == null){
                break;
            }
            for(Facility facility: this.facilities){
                ...
                if(facility.satisfies(objFacility)){
                    satisfy = true;
                }
            }
            if(!satisfy){
    ...
    public void addPrenotazione(TimeSlot ts, String docente, String motivo) {
        ...
        for (Prenotazione prenotazione : prenotazioni){
            ...
            Aula otherAula = prenotazione.getAula();
            if ((this.nome == otherAula.nome) && (prenotazione.getTimeSlot().overlapsWith(ts))){
                throw new IllegalArgumentException("Non è possibile prenotare nella stessa aula in questo TimeSlot");
            }
        }
